    ...
    <div className='p-7 font-handlee flex flex-col sm:flex-row sm:items-end justify-between gap-5 sm:gap-0'>
      <div className='flex flex-col'>
        <div className='flex flex-row items-center justify-start sm:gap-3 translate-x-[-1rem] sm:translate-x-0'>
          ...
          <span className='bg-pink-300 text-xl font-bold translate-y-[-1rem] transform rotate-[-10deg] drop-shadow-md'>Hi, I&apos;m Prateek</span>
        </div>
      ...
      <div className='sm:w-6/12 mb-2'>
          <p className='font-inter text-[1.2rem] text-wrap '>As a frontend developer, I create dynamic and engaging websites with the power of coding languages and modern frameworks.</p>
          <ShimmerButton className='mt-5 text-2xl w-32'>Hire Me</ShimmerButton>
      </div>
